...
public class EditCharTest extends IOManagerControllerTest {
  ...
  @Test
  public void successfulEditCharRole() {
    Readable input = new StringReader("create-char\n"
        + "Onion\n"
        + "Steven\n"
        + "Human\n"
    ...
    assertTrue(this.model.doesCharacterExist("Onion"));
    assertEquals("Wizard", this.model.findCharByName("Onion").getRole());
    assertEquals("You are now in character editing mode.\n"
            + "Editing: Onion (Steven)\n"
            + "Onion (Steven)\n"
            + "Role: Human (New Yorker)\n"
  ...
  @Test
  public void successfulEditCharRoleSpec() {
    Readable input = new StringReader("create-char\n"
        + "Onion\n"
        + "Steven\n"
        + "Human\n"
    ...
    assertEquals("You are now in character editing mode.\n"
            ...
            + "Intimidation: 1 (+1)\n"
            + "Awaiting edit command:\n"
            + "Current Role Specification: New Yorker\n"
            + "New Role Specification (Type enter to leave blank): \n"
            + "Onion (Steven)\n"
            + "Role: Human (Salvadorian)\n"
            + "Hp: 100/100\n"
            + "Strength: 1 (+1)\n"
            + "Intelligence: 1 (+1)\n"
            + "Creativity: 1 (+1)\n"
