...
/**
 * Represents a group of {@code Character}s that participate in a campaign. This interface contains
 * methods for getting members of the party and damaging/healing members of a party.
 */
public interface Party {
   ...
   * @throws IllegalArgumentException if there's no character with the given name OR if the given
   *                                  String is null
   */
